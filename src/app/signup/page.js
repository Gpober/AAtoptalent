        ...
        <div className="w-full max-w-lg">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Join A&A Top Talent to find your next opportunity</p>
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  type="button"
                  onClick={() => setFormData(prev => ({ ...prev, accountType: 'candidate' }))}
                ...
                >
                  <User className={`w-6 h-6 mb-2 ${formData.accountType === 'candidate' ? 'text-blue-900' : 'text-gray-400'}`} />
                  <div className={`font-semibold ${formData.accountType === 'candidate' ? 'text-blue-900' : 'text-gray-900'}`}>
                    Job Seeker
                  </div>
                ...
                >
                  <Building className={`w-6 h-6 mb-2 ${formData.accountType === 'employer' ? 'text-blue-900' : 'text-gray-400'}`} />
                  <div className={`font-semibold ${formData.accountType === 'employer' ? 'text-blue-900' : 'text-gray-900'}`}>
                    Employer
                  </div>
                  <div className="text-sm text-gray-500">Hiring top talent</div>
                </button>
              </div>
            </div>
